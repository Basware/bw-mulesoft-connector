...
public class GetV1ExportedContractsOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-exported-contracts-output-schema.json";
  }
