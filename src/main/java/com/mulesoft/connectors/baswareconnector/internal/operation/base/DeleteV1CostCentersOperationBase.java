...
public abstract class DeleteV1CostCentersOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/costCenters";
  ...
  public DeleteV1CostCentersOperationBase() {
    super();
  }

  public DeleteV1CostCentersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1CostCenters(
  ...
  protected void deleteV1CostCentersMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1CostCentersBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
