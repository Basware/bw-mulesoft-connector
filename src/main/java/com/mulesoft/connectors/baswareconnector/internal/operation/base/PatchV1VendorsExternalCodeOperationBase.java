...
public abstract class PatchV1VendorsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/vendors/{externalCode}";
  ...
  public PatchV1VendorsExternalCodeOperationBase() {
    super();
  }

  public PatchV1VendorsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1VendorsExternalCode(
    ...
    try {
      ...
      patchV1VendorsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1VendorsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1VendorsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
