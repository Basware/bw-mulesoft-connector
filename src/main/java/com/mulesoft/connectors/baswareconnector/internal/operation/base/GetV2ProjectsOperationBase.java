...
public abstract class GetV2ProjectsOperationBase extends BaseRestOperation {
  ...
  public GetV2ProjectsOperationBase() {
    super();
  }

  public GetV2ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV2Projects(
  ...
  protected void getV2ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
