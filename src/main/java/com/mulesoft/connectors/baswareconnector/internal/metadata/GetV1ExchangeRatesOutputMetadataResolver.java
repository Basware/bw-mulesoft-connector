...
public class GetV1ExchangeRatesOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-exchange-rates-output-schema.json";
  }
