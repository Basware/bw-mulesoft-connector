...
public abstract class GetV1RequestStatusRequestIdOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/requestStatus/{requestId}";
  ...
  public GetV1RequestStatusRequestIdOperationBase() {
    super();
  }

  public GetV1RequestStatusRequestIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1RequestStatusRequestId(
    ...
    try {
      ...
      getV1RequestStatusRequestIdMain(
          config,
          connection,
          requestIdUriParam,
          systemQueryParam,
  ...
  protected void getV1RequestStatusRequestIdMain(
      RestConfiguration config,
      RestConnection connection,
      String requestIdUriParam,
      String systemQueryParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addUriParam("requestId", requestIdUriParam)
            .addQueryParam("system", systemQueryParam)
            .addQueryParam("ignoreSuccessfulItems", ignoreSuccessfulItemsQueryParam);
    doRequest(
        config,
        connection,
        builder,
