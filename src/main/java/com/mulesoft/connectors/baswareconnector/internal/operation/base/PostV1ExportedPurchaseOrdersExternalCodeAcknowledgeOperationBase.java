...
public abstract class PostV1ExportedPurchaseOrdersExternalCodeAcknowledgeOperationBase
  ...
  public PostV1ExportedPurchaseOrdersExternalCodeAcknowledgeOperationBase() {
    super();
  }

  public PostV1ExportedPurchaseOrdersExternalCodeAcknowledgeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1ExportedPurchaseOrdersExternalCodeAcknowledge(
    ...
    try {
      ...
      postV1ExportedPurchaseOrdersExternalCodeAcknowledgeMain(
          config,
          connection,
  ...
  protected void postV1ExportedPurchaseOrdersExternalCodeAcknowledgeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
      String contentTypeHeader,
