...
public abstract class PostV1AdvancedPermissionsOperationBase extends BaseRestOperation {
  ...
  public PostV1AdvancedPermissionsOperationBase() {
    super();
  }

  public PostV1AdvancedPermissionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AdvancedPermissions(
  ...
  protected void postV1AdvancedPermissionsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1AdvancedPermissionsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
