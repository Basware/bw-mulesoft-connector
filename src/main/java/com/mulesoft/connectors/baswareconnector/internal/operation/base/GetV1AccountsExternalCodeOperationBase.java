...
public abstract class GetV1AccountsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1AccountsExternalCodeOperationBase() {
    super();
  }

  public GetV1AccountsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AccountsExternalCode(
  ...
  protected void getV1AccountsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
