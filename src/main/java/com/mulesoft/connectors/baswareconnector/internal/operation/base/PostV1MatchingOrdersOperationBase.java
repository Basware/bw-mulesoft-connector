...
public abstract class PostV1MatchingOrdersOperationBase extends BaseRestOperation {
  ...
  public PostV1MatchingOrdersOperationBase() {
    super();
  }

  public PostV1MatchingOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1MatchingOrders(
  ...
  protected void postV1MatchingOrdersMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1MatchingOrdersBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
