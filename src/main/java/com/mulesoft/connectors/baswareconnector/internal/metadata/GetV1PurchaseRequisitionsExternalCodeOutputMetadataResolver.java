...
public class GetV1PurchaseRequisitionsExternalCodeOutputMetadataResolver
    extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-purchase-requisitions-external-code-output-schema.json";
  }
