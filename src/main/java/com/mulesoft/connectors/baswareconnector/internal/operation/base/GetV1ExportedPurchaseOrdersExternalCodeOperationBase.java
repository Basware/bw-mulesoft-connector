...
public abstract class GetV1ExportedPurchaseOrdersExternalCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedPurchaseOrders/{externalCode}";
  ...
  public GetV1ExportedPurchaseOrdersExternalCodeOperationBase() {
    super();
  }

  public GetV1ExportedPurchaseOrdersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedPurchaseOrdersExternalCode(
    ...
    try {
      ...
      getV1ExportedPurchaseOrdersExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ExportedPurchaseOrdersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
