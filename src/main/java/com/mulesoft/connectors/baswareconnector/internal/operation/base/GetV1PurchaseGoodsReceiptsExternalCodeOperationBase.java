...
public abstract class GetV1PurchaseGoodsReceiptsExternalCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/purchaseGoodsReceipts/{externalCode}";
  ...
  public GetV1PurchaseGoodsReceiptsExternalCodeOperationBase() {
    super();
  }

  public GetV1PurchaseGoodsReceiptsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseGoodsReceiptsExternalCode(
    ...
    try {
      ...
      getV1PurchaseGoodsReceiptsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1PurchaseGoodsReceiptsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
