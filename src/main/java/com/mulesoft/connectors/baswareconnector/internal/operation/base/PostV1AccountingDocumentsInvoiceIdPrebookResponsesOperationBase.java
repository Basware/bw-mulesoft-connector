...
public abstract class PostV1AccountingDocumentsInvoiceIdPrebookResponsesOperationBase
  ...
  public PostV1AccountingDocumentsInvoiceIdPrebookResponsesOperationBase() {
    super();
  }

  public PostV1AccountingDocumentsInvoiceIdPrebookResponsesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AccountingDocumentsInvoiceIdPrebookResponses(
    ...
    try {
      ...
      postV1AccountingDocumentsInvoiceIdPrebookResponsesMain(
          config,
          connection,
          invoiceIdUriParam,
          contentTypeHeader,
  ...
  protected void postV1AccountingDocumentsInvoiceIdPrebookResponsesMain(
      RestConfiguration config,
      RestConnection connection,
      String invoiceIdUriParam,
      String contentTypeHeader,
