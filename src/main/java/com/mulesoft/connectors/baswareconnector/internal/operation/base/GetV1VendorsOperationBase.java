...
public abstract class GetV1VendorsOperationBase extends BaseRestOperation {
  ...
  public GetV1VendorsOperationBase() {
    super();
  }

  public GetV1VendorsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1Vendors(
  ...
  protected void getV1VendorsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
