...
public abstract class DeleteV1ExportedContractSpendsOperationBase extends BaseRestOperation {
  ...
  public DeleteV1ExportedContractSpendsOperationBase() {
    super();
  }

  public DeleteV1ExportedContractSpendsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1ExportedContractSpends(
    ...
    try {
      ...
      deleteV1ExportedContractSpendsMain(
          config,
          connection,
  ...
  protected void deleteV1ExportedContractSpendsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ExportedContractSpendsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
