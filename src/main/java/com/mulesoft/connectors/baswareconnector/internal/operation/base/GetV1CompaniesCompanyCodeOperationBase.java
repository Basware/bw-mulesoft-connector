...
public abstract class GetV1CompaniesCompanyCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/companies/{companyCode}";
  ...
  public GetV1CompaniesCompanyCodeOperationBase() {
    super();
  }

  public GetV1CompaniesCompanyCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1CompaniesCompanyCode(
  ...
  protected void getV1CompaniesCompanyCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String companyCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addUriParam("companyCode", companyCodeUriParam);
    doRequest(
        config,
        connection,
        builder,
