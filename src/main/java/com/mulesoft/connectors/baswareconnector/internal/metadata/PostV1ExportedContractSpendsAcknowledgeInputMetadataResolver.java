...
public class PostV1ExportedContractSpendsAcknowledgeInputMetadataResolver
    extends JsonInputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-exported-contract-spends-acknowledge-input-schema.json";
  }
