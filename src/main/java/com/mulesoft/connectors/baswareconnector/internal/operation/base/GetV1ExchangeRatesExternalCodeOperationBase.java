...
public abstract class GetV1ExchangeRatesExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1ExchangeRatesExternalCodeOperationBase() {
    super();
  }

  public GetV1ExchangeRatesExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExchangeRatesExternalCode(
    ...
    try {
      ...
      getV1ExchangeRatesExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ExchangeRatesExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
