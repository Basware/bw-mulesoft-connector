...
public abstract class DeleteV1MatchingOrderLinesOperationBase extends BaseRestOperation {
  ...
  public DeleteV1MatchingOrderLinesOperationBase() {
    super();
  }

  public DeleteV1MatchingOrderLinesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1MatchingOrderLines(
    ...
    try {
      ...
      deleteV1MatchingOrderLinesMain(
          config,
          connection,
  ...
  protected void deleteV1MatchingOrderLinesMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1MatchingOrderLinesBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
