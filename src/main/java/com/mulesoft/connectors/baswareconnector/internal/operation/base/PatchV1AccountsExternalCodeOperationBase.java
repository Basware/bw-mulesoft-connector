...
public abstract class PatchV1AccountsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/accounts/{externalCode}";
  ...
  public PatchV1AccountsExternalCodeOperationBase() {
    super();
  }

  public PatchV1AccountsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1AccountsExternalCode(
    ...
    try {
      ...
      patchV1AccountsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1AccountsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1AccountsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
