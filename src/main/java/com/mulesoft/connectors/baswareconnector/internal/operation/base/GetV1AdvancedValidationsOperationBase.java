...
public abstract class GetV1AdvancedValidationsOperationBase extends BaseRestOperation {
  ...
  public GetV1AdvancedValidationsOperationBase() {
    super();
  }

  public GetV1AdvancedValidationsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AdvancedValidations(
  ...
  protected void getV1AdvancedValidationsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
