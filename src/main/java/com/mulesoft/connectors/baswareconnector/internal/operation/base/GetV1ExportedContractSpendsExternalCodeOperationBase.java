...
public abstract class GetV1ExportedContractSpendsExternalCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContractSpends/{externalCode}";
  ...
  public GetV1ExportedContractSpendsExternalCodeOperationBase() {
    super();
  }

  public GetV1ExportedContractSpendsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedContractSpendsExternalCode(
    ...
    try {
      ...
      getV1ExportedContractSpendsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ExportedContractSpendsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
