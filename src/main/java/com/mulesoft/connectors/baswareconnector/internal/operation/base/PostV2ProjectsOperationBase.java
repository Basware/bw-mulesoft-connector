...
public abstract class PostV2ProjectsOperationBase extends BaseRestOperation {
  ...
  public PostV2ProjectsOperationBase() {
    super();
  }

  public PostV2ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV2Projects(
  ...
  protected void postV2ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV2ProjectsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
