...
public abstract class PatchV1AdvancedValidationsExternalCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/advancedValidations/{externalCode}";
  ...
  public PatchV1AdvancedValidationsExternalCodeOperationBase() {
    super();
  }

  public PatchV1AdvancedValidationsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1AdvancedValidationsExternalCode(
    ...
    try {
      ...
      patchV1AdvancedValidationsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1AdvancedValidationsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1AdvancedValidationsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
