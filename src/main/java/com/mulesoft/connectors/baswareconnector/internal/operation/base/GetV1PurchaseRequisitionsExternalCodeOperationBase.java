...
public abstract class GetV1PurchaseRequisitionsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/purchaseRequisitions/{externalCode}";
  ...
  public GetV1PurchaseRequisitionsExternalCodeOperationBase() {
    super();
  }

  public GetV1PurchaseRequisitionsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseRequisitionsExternalCode(
    ...
    try {
      ...
      getV1PurchaseRequisitionsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1PurchaseRequisitionsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
