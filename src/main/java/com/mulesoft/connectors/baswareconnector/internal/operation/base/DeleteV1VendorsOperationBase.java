...
public abstract class DeleteV1VendorsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/vendors";
  ...
  public DeleteV1VendorsOperationBase() {
    super();
  }

  public DeleteV1VendorsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1Vendors(
  ...
  protected void deleteV1VendorsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1VendorsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
