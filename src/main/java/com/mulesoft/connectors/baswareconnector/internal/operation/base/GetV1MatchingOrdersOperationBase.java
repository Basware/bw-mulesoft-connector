...
public abstract class GetV1MatchingOrdersOperationBase extends BaseRestOperation {
  ...
  public GetV1MatchingOrdersOperationBase() {
    super();
  }

  public GetV1MatchingOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1MatchingOrders(
  ...
  protected void getV1MatchingOrdersMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addQueryParam("orderStatus", orderStatusQueryParam)
            .addQueryParam(
