...
public abstract class GetV1PaymentTermsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1PaymentTermsExternalCodeOperationBase() {
    super();
  }

  public GetV1PaymentTermsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PaymentTermsExternalCode(
    ...
    try {
      ...
      getV1PaymentTermsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1PaymentTermsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
