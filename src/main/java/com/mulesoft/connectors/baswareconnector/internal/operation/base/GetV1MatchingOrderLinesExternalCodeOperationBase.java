...
public abstract class GetV1MatchingOrderLinesExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1MatchingOrderLinesExternalCodeOperationBase() {
    super();
  }

  public GetV1MatchingOrderLinesExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1MatchingOrderLinesExternalCode(
    ...
    try {
      ...
      getV1MatchingOrderLinesExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1MatchingOrderLinesExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
