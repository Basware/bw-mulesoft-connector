...
public abstract class GetV1CostCentersOperationBase extends BaseRestOperation {
  ...
  public GetV1CostCentersOperationBase() {
    super();
  }

  public GetV1CostCentersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1CostCenters(
  ...
  protected void getV1CostCentersMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
