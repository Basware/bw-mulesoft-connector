...
public abstract class GetV1AdvancedPermissionsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1AdvancedPermissionsExternalCodeOperationBase() {
    super();
  }

  public GetV1AdvancedPermissionsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AdvancedPermissionsExternalCode(
    ...
    try {
      ...
      getV1AdvancedPermissionsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1AdvancedPermissionsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
