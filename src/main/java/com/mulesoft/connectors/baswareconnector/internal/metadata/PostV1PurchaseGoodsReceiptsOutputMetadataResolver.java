...
public class PostV1PurchaseGoodsReceiptsOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-purchase-goods-receipts-output-schema.json";
  }
