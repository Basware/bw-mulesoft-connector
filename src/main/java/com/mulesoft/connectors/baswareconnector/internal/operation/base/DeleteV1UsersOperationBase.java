...
public abstract class DeleteV1UsersOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/users";
  ...
  public DeleteV1UsersOperationBase() {
    super();
  }

  public DeleteV1UsersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1Users(
  ...
  protected void deleteV1UsersMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1UsersBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
