...
public abstract class DeleteV1ExportedPurchaseRequisitionsOperationBase extends BaseRestOperation {
  ...
  public DeleteV1ExportedPurchaseRequisitionsOperationBase() {
    super();
  }

  public DeleteV1ExportedPurchaseRequisitionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1ExportedPurchaseRequisitions(
    ...
    try {
      ...
      deleteV1ExportedPurchaseRequisitionsMain(
          config,
          connection,
  ...
  protected void deleteV1ExportedPurchaseRequisitionsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ExportedPurchaseRequisitionsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
