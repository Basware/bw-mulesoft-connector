...
public abstract class PatchV1ContractsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/contracts/{externalCode}";
  ...
  public PatchV1ContractsExternalCodeOperationBase() {
    super();
  }

  public PatchV1ContractsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1ContractsExternalCode(
    ...
    try {
      ...
      patchV1ContractsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1ContractsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1ContractsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
