...
public abstract class PostV1AccountingDocumentsInvoiceIdAcknowledgeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/accountingDocuments/{invoiceId}/acknowledge";
  ...
  public PostV1AccountingDocumentsInvoiceIdAcknowledgeOperationBase() {
    super();
  }

  public PostV1AccountingDocumentsInvoiceIdAcknowledgeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AccountingDocumentsInvoiceIdAcknowledge(
    ...
    try {
      ...
      postV1AccountingDocumentsInvoiceIdAcknowledgeMain(
          config,
          connection,
          invoiceIdUriParam,
          contentTypeHeader,
  ...
  protected void postV1AccountingDocumentsInvoiceIdAcknowledgeMain(
      RestConfiguration config,
      RestConnection connection,
      String invoiceIdUriParam,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addUriParam("invoiceId", invoiceIdUriParam)
