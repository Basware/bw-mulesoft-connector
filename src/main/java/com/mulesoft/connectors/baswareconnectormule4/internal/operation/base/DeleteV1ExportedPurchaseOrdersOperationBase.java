...
public abstract class DeleteV1ExportedPurchaseOrdersOperationBase extends BaseRestOperation {
  ...
  public DeleteV1ExportedPurchaseOrdersOperationBase() {
    super();
  }

  public DeleteV1ExportedPurchaseOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1ExportedPurchaseOrders(
    ...
    try {
      ...
      deleteV1ExportedPurchaseOrdersMain(
          config,
          connection,
  ...
  protected void deleteV1ExportedPurchaseOrdersMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ExportedPurchaseOrdersBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
