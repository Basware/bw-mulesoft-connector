...
public class PatchV1ProjectsExternalCodeOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-projects-external-code-output-schema.json";
  }
