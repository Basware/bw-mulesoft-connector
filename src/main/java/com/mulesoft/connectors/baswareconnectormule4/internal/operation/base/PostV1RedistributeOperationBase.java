...
public abstract class PostV1RedistributeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/redistribute";
  ...
  public PostV1RedistributeOperationBase() {
    super();
  }

  public PostV1RedistributeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Redistribute(
  ...
  protected void postV1RedistributeMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1RedistributeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
