...
public abstract class PatchV1MatchingOrderLinesExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/matchingOrderLines/{externalCode}";
  ...
  public PatchV1MatchingOrderLinesExternalCodeOperationBase() {
    super();
  }

  public PatchV1MatchingOrderLinesExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1MatchingOrderLinesExternalCode(
    ...
    try {
      ...
      patchV1MatchingOrderLinesExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1MatchingOrderLinesExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1MatchingOrderLinesExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
