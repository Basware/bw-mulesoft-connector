...
public class PostV1AdvancedValidationsOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-advanced-validations-input-schema.json";
  }
