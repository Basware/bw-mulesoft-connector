...
public abstract class GetV1AdvancedPermissionsOperationBase extends BaseRestOperation {
  ...
  public GetV1AdvancedPermissionsOperationBase() {
    super();
  }

  public GetV1AdvancedPermissionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AdvancedPermissions(
  ...
  protected void getV1AdvancedPermissionsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
