...
public abstract class GetV1ExportedPurchaseRequisitionsExternalCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedPurchaseRequisitions/{externalCode}";
  ...
  public GetV1ExportedPurchaseRequisitionsExternalCodeOperationBase() {
    super();
  }

  public GetV1ExportedPurchaseRequisitionsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedPurchaseRequisitionsExternalCode(
    ...
    try {
      ...
      getV1ExportedPurchaseRequisitionsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ExportedPurchaseRequisitionsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
