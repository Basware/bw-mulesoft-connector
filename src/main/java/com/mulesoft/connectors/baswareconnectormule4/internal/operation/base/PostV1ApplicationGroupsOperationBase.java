...
public abstract class PostV1ApplicationGroupsOperationBase extends BaseRestOperation {
  ...
  public PostV1ApplicationGroupsOperationBase() {
    super();
  }

  public PostV1ApplicationGroupsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1ApplicationGroups(
  ...
  protected void postV1ApplicationGroupsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1ApplicationGroupsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
