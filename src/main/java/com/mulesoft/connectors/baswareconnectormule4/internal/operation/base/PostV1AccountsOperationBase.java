...
public abstract class PostV1AccountsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/accounts";
  ...
  public PostV1AccountsOperationBase() {
    super();
  }

  public PostV1AccountsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Accounts(
  ...
  protected void postV1AccountsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1AccountsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
