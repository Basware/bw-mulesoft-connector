...
public abstract class PatchV1PurchaseOrdersExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/purchaseOrders/{externalCode}";
  ...
  public PatchV1PurchaseOrdersExternalCodeOperationBase() {
    super();
  }

  public PatchV1PurchaseOrdersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1PurchaseOrdersExternalCode(
    ...
    try {
      ...
      patchV1PurchaseOrdersExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1PurchaseOrdersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1PurchaseOrdersExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
