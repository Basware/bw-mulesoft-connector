...
public abstract class GetV1ContractsOperationBase extends BaseRestOperation {
  ...
  public GetV1ContractsOperationBase() {
    super();
  }

  public GetV1ContractsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1Contracts(
  ...
  protected void getV1ContractsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
