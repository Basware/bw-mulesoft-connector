...
public abstract class GetV1ExportedContractsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContracts/{externalCode}";
  ...
  public GetV1ExportedContractsExternalCodeOperationBase() {
    super();
  }

  public GetV1ExportedContractsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedContractsExternalCode(
    ...
    try {
      ...
      getV1ExportedContractsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ExportedContractsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
