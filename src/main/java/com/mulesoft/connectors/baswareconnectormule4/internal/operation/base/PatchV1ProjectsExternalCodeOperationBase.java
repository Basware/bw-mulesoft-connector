...
public abstract class PatchV1ProjectsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/projects/{externalCode}";
  ...
  public PatchV1ProjectsExternalCodeOperationBase() {
    super();
  }

  public PatchV1ProjectsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1ProjectsExternalCode(
    ...
    try {
      ...
      patchV1ProjectsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1ProjectsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1ProjectsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
