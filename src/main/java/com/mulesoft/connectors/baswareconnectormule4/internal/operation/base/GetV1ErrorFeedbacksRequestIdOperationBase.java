...
public abstract class GetV1ErrorFeedbacksRequestIdOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/errorFeedbacks/{requestId}";
  ...
  public GetV1ErrorFeedbacksRequestIdOperationBase() {
    super();
  }

  public GetV1ErrorFeedbacksRequestIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ErrorFeedbacksRequestId(
    ...
    try {
      ...
      getV1ErrorFeedbacksRequestIdMain(
          config,
          connection,
          requestIdUriParam,
          pageSizeQueryParam,
  ...
  protected void getV1ErrorFeedbacksRequestIdMain(
      RestConfiguration config,
      RestConnection connection,
      String requestIdUriParam,
      Integer pageSizeQueryParam,
