...
public abstract class PostV1AccountingDocumentsInvoiceIdPaymentResponsesOperationBase
  ...
  public PostV1AccountingDocumentsInvoiceIdPaymentResponsesOperationBase() {
    super();
  }

  public PostV1AccountingDocumentsInvoiceIdPaymentResponsesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AccountingDocumentsInvoiceIdPaymentResponses(
    ...
    try {
      ...
      postV1AccountingDocumentsInvoiceIdPaymentResponsesMain(
          config,
          connection,
          invoiceIdUriParam,
          contentTypeHeader,
  ...
  protected void postV1AccountingDocumentsInvoiceIdPaymentResponsesMain(
      RestConfiguration config,
      RestConnection connection,
      String invoiceIdUriParam,
      String contentTypeHeader,
