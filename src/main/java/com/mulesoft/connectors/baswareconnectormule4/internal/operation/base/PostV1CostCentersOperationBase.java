...
public abstract class PostV1CostCentersOperationBase extends BaseRestOperation {
  ...
  public PostV1CostCentersOperationBase() {
    super();
  }

  public PostV1CostCentersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1CostCenters(
  ...
  protected void postV1CostCentersMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1CostCentersBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
