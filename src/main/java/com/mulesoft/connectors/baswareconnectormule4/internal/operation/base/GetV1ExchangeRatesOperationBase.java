...
public abstract class GetV1ExchangeRatesOperationBase extends BaseRestOperation {
  ...
  public GetV1ExchangeRatesOperationBase() {
    super();
  }

  public GetV1ExchangeRatesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExchangeRates(
  ...
  protected void getV1ExchangeRatesMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
