...
public class PostV1PurchaseOrdersInputMetadataResolver extends JsonInputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-purchase-orders-input-schema.json";
  }
