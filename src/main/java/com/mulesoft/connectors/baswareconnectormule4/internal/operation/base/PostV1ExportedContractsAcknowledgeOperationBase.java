...
public abstract class PostV1ExportedContractsAcknowledgeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContracts/acknowledge";
  ...
  public PostV1ExportedContractsAcknowledgeOperationBase() {
    super();
  }

  public PostV1ExportedContractsAcknowledgeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1ExportedContractsAcknowledge(
    ...
    try {
      ...
      postV1ExportedContractsAcknowledgeMain(
          config,
          connection,
          contentTypeHeader,
  ...
  protected void postV1ExportedContractsAcknowledgeMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1ExportedContractsAcknowledgeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
