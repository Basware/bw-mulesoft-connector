...
public abstract class GetV1CostCentersExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1CostCentersExternalCodeOperationBase() {
    super();
  }

  public GetV1CostCentersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1CostCentersExternalCode(
    ...
    try {
      ...
      getV1CostCentersExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1CostCentersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
