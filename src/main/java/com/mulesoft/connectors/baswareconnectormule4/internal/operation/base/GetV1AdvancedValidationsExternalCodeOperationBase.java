...
public abstract class GetV1AdvancedValidationsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1AdvancedValidationsExternalCodeOperationBase() {
    super();
  }

  public GetV1AdvancedValidationsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AdvancedValidationsExternalCode(
    ...
    try {
      ...
      getV1AdvancedValidationsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1AdvancedValidationsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
