...
import com.mulesoft.connectors.baswareconnectormule4.api.metadata.GetV1ExportedContractsOperationProcessingStatusQueryParamEnum;
...
public abstract class GetV1ExportedContractsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContracts";
  ...
  public GetV1ExportedContractsOperationBase() {
    super();
  }

  public GetV1ExportedContractsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedContracts(
  ...
  protected void getV1ExportedContractsMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1ExportedContractsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
      Integer pageSizeQueryParam,
