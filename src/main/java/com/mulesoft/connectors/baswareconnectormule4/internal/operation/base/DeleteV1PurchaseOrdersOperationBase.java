...
public abstract class DeleteV1PurchaseOrdersOperationBase extends BaseRestOperation {
  ...
  public DeleteV1PurchaseOrdersOperationBase() {
    super();
  }

  public DeleteV1PurchaseOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1PurchaseOrders(
  ...
  protected void deleteV1PurchaseOrdersMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1PurchaseOrdersBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
