...
public abstract class PostV1UsersOperationBase extends BaseRestOperation {
  ...
  public PostV1UsersOperationBase() {
    super();
  }

  public PostV1UsersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Users(
  ...
  protected void postV1UsersMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1UsersBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
