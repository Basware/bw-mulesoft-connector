...
public abstract class GetV1TaxCodesExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1TaxCodesExternalCodeOperationBase() {
    super();
  }

  public GetV1TaxCodesExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1TaxCodesExternalCode(
  ...
  protected void getV1TaxCodesExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
