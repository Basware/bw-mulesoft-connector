...
public abstract class PostV1ContractsOperationBase extends BaseRestOperation {
  ...
  public PostV1ContractsOperationBase() {
    super();
  }

  public PostV1ContractsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Contracts(
  ...
  protected void postV1ContractsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1ContractsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
