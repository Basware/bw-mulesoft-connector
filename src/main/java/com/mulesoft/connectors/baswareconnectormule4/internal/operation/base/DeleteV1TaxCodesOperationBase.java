...
public abstract class DeleteV1TaxCodesOperationBase extends BaseRestOperation {
  ...
  public DeleteV1TaxCodesOperationBase() {
    super();
  }

  public DeleteV1TaxCodesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1TaxCodes(
    ...
    try {
      ...
      deleteV1TaxCodesMain(
          config,
          connection,
          customParameterBindings,
          deleteV1TaxCodesBody,
          parameters,
          overrides,
          streamingHelper,
          callback);
  ...
  protected void deleteV1TaxCodesMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1TaxCodesBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
