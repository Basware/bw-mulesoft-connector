...
public abstract class PostV1PaymentTermsOperationBase extends BaseRestOperation {
  ...
  public PostV1PaymentTermsOperationBase() {
    super();
  }

  public PostV1PaymentTermsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1PaymentTerms(
  ...
  protected void postV1PaymentTermsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1PaymentTermsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
