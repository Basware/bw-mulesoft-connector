...
public abstract class GetV1MatchingOrdersExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1MatchingOrdersExternalCodeOperationBase() {
    super();
  }

  public GetV1MatchingOrdersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1MatchingOrdersExternalCode(
    ...
    try {
      ...
      getV1MatchingOrdersExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1MatchingOrdersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
