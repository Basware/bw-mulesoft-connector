...
public abstract class DeleteV2ProjectsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v2/projects";
  ...
  public DeleteV2ProjectsOperationBase() {
    super();
  }

  public DeleteV2ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV2Projects(
    ...
    try {
      ...
      deleteV2ProjectsMain(
          config,
          connection,
          customParameterBindings,
          deleteV2ProjectsBody,
          parameters,
          overrides,
          streamingHelper,
          callback);
  ...
  protected void deleteV2ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV2ProjectsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
