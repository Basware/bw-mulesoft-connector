...
public abstract class GetV1AccountsOperationBase extends BaseRestOperation {
  ...
  public GetV1AccountsOperationBase() {
    super();
  }

  public GetV1AccountsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1Accounts(
  ...
  protected void getV1AccountsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
