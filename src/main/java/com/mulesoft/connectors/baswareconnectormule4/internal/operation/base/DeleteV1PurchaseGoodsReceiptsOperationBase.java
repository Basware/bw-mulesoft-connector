...
public abstract class DeleteV1PurchaseGoodsReceiptsOperationBase extends BaseRestOperation {
  ...
  public DeleteV1PurchaseGoodsReceiptsOperationBase() {
    super();
  }

  public DeleteV1PurchaseGoodsReceiptsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1PurchaseGoodsReceipts(
    ...
    try {
      ...
      deleteV1PurchaseGoodsReceiptsMain(
          config,
          connection,
  ...
  protected void deleteV1PurchaseGoodsReceiptsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1PurchaseGoodsReceiptsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
