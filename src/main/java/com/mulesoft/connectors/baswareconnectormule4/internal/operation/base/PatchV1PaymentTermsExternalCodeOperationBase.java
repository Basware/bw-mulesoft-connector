...
public abstract class PatchV1PaymentTermsExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/paymentTerms/{externalCode}";
  ...
  public PatchV1PaymentTermsExternalCodeOperationBase() {
    super();
  }

  public PatchV1PaymentTermsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1PaymentTermsExternalCode(
    ...
    try {
      ...
      patchV1PaymentTermsExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1PaymentTermsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1PaymentTermsExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
