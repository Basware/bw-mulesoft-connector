...
public abstract class PostV1VendorsOperationBase extends BaseRestOperation {
  ...
  public PostV1VendorsOperationBase() {
    super();
  }

  public PostV1VendorsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Vendors(
  ...
  protected void postV1VendorsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1VendorsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
