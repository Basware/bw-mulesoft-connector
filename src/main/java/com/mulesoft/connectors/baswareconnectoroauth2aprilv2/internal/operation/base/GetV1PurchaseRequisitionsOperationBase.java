...
public abstract class GetV1PurchaseRequisitionsOperationBase extends BaseRestOperation {
  ...
  public GetV1PurchaseRequisitionsOperationBase() {
    super();
  }

  public GetV1PurchaseRequisitionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseRequisitions(
  ...
  protected void getV1PurchaseRequisitionsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
