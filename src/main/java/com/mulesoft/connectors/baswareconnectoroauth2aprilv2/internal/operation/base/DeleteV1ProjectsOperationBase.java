...
public abstract class DeleteV1ProjectsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/projects";
  ...
  public DeleteV1ProjectsOperationBase() {
    super();
  }

  public DeleteV1ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1Projects(
    ...
    try {
      ...
      deleteV1ProjectsMain(
          config,
          connection,
          customParameterBindings,
          deleteV1ProjectsBody,
          parameters,
          overrides,
          streamingHelper,
          callback);
  ...
  protected void deleteV1ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ProjectsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
