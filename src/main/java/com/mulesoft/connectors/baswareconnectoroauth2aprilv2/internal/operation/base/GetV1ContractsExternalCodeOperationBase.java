...
public abstract class GetV1ContractsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1ContractsExternalCodeOperationBase() {
    super();
  }

  public GetV1ContractsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ContractsExternalCode(
    ...
    try {
      ...
      getV1ContractsExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1ContractsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
