...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1PurchaseGoodsReceiptsOperationProcessingStatusQueryParamEnum;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1PurchaseGoodsReceiptsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1PurchaseGoodsReceiptsOperationRefinement;
...
public class GetV1PurchaseGoodsReceiptsOperation
    extends GetV1PurchaseGoodsReceiptsOperationRefinement {
  public GetV1PurchaseGoodsReceiptsOperation() {
    super();
  }

  public GetV1PurchaseGoodsReceiptsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Get v1 purchase goods receipts
   *
   * <p>This operation makes an HTTP GET request to the /v1/purchaseGoodsReceipts endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param processingStatusQueryParam Document status filter. Returns items by purchase goods
   *     receipt status.
  ...
  @DisplayName("Get v1 purchase goods receipts")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1PurchaseGoodsReceiptsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1PurchaseGoodsReceipts(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @Optional
          @DisplayName("Processing Status")
          @Summary("Document status filter. Returns items by purchase goods receipt status.")
          GetV1PurchaseGoodsReceiptsOperationProcessingStatusQueryParamEnum
    ...
    super.getV1PurchaseGoodsReceipts(
        config,
        connection,
        processingStatusQueryParam,
        pageSizeQueryParam,
