...
public abstract class DeleteV1ExchangeRatesOperationBase extends BaseRestOperation {
  ...
  public DeleteV1ExchangeRatesOperationBase() {
    super();
  }

  public DeleteV1ExchangeRatesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1ExchangeRates(
  ...
  protected void deleteV1ExchangeRatesMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ExchangeRatesBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
