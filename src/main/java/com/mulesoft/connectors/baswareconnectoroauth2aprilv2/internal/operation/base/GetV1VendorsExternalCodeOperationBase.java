...
public abstract class GetV1VendorsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1VendorsExternalCodeOperationBase() {
    super();
  }

  public GetV1VendorsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1VendorsExternalCode(
  ...
  protected void getV1VendorsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
