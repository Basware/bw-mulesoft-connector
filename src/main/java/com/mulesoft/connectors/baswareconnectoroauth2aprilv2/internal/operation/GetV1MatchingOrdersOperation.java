...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1MatchingOrdersOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1MatchingOrdersOperationRefinement;
...
public class GetV1MatchingOrdersOperation extends GetV1MatchingOrdersOperationRefinement {
  public GetV1MatchingOrdersOperation() {
    super();
  }

  public GetV1MatchingOrdersOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Get v1 matching orders
   *
   * <p>This operation makes an HTTP GET request to the /v1/matchingOrders endpoint
   *
   ...
   * @param orderStatusQueryParam Order status filter. Returns items for specific status.
  ...
  @DisplayName("Get v1 matching orders")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1MatchingOrdersOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1MatchingOrders(
      ...
      @Optional
          ...
          @Summary("Order status filter. Returns items for specific status.")
          String orderStatusQueryParam,
      @Optional
