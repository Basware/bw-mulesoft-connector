...
public abstract class DeleteV1PaymentTermsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/paymentTerms";
  ...
  public DeleteV1PaymentTermsOperationBase() {
    super();
  }

  public DeleteV1PaymentTermsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1PaymentTerms(
  ...
  protected void deleteV1PaymentTermsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1PaymentTermsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
