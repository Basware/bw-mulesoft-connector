...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1MatchingOrderLinesOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1MatchingOrderLinesOperationRefinement;
...
public class GetV1MatchingOrderLinesOperation extends GetV1MatchingOrderLinesOperationRefinement {
  public GetV1MatchingOrderLinesOperation() {
    super();
  }

  public GetV1MatchingOrderLinesOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Get v1 matching order lines
   *
   * <p>This operation makes an HTTP GET request to the /v1/matchingOrderLines endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param orderExternalCodeQueryParam The externalCode of the order.
  ...
  @DisplayName("Get v1 matching order lines")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1MatchingOrderLinesOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1MatchingOrderLines(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @Optional @DisplayName("Order External Code") @Summary("The externalCode of the order.")
