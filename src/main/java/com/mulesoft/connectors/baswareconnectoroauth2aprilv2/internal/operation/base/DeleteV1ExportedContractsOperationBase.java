...
public abstract class DeleteV1ExportedContractsOperationBase extends BaseRestOperation {
  ...
  public DeleteV1ExportedContractsOperationBase() {
    super();
  }

  public DeleteV1ExportedContractsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1ExportedContracts(
  ...
  protected void deleteV1ExportedContractsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ExportedContractsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
