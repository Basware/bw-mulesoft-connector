...
public abstract class PostV1AdvancedValidationsOperationBase extends BaseRestOperation {
  ...
  public PostV1AdvancedValidationsOperationBase() {
    super();
  }

  public PostV1AdvancedValidationsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AdvancedValidations(
  ...
  protected void postV1AdvancedValidationsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1AdvancedValidationsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
