...
public abstract class GetV1ApplicationGroupsApplicationGroupCodeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/applicationGroups/{applicationGroupCode}";
  ...
  public GetV1ApplicationGroupsApplicationGroupCodeOperationBase() {
    super();
  }

  public GetV1ApplicationGroupsApplicationGroupCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ApplicationGroupsApplicationGroupCode(
    ...
    try {
      ...
      getV1ApplicationGroupsApplicationGroupCodeMain(
          config,
          connection,
  ...
  protected void getV1ApplicationGroupsApplicationGroupCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String applicationGroupCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addUriParam("applicationGroupCode", applicationGroupCodeUriParam);
    doRequest(
        config,
        connection,
        builder,
