...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1PurchaseOrdersOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1PurchaseOrdersOperationRefinement;
...
public class GetV1PurchaseOrdersOperation extends GetV1PurchaseOrdersOperationRefinement {
  ...
  @DisplayName("Get v1 purchase orders")
  @Summary(
      "Note: This GET operation returns a HTTP redirect, which the API client needs to follow. \r\n"
