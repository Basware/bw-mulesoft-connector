...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1ProjectsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1ProjectsOperationRefinement;
...
public class GetV1ProjectsOperation extends GetV1ProjectsOperationRefinement {
  public GetV1ProjectsOperation() {
    super();
  }

  public GetV1ProjectsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 projects
   *
   * <p>This operation makes an HTTP GET request to the /v1/projects endpoint
   *
  ...
  @OutputResolver(
      output = GetV1ProjectsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1Projects(
