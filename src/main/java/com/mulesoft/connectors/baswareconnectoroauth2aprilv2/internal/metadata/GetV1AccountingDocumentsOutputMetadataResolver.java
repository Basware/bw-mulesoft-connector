...
public class GetV1AccountingDocumentsOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-accounting-documents-output-schema.json";
  }
