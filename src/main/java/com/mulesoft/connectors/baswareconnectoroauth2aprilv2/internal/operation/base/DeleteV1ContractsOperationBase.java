...
public abstract class DeleteV1ContractsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/contracts";
  ...
  public DeleteV1ContractsOperationBase() {
    super();
  }

  public DeleteV1ContractsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1Contracts(
  ...
  protected void deleteV1ContractsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1ContractsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
