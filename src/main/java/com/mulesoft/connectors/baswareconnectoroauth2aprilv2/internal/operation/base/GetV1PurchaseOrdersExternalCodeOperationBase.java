...
public abstract class GetV1PurchaseOrdersExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1PurchaseOrdersExternalCodeOperationBase() {
    super();
  }

  public GetV1PurchaseOrdersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseOrdersExternalCode(
    ...
    try {
      ...
      getV1PurchaseOrdersExternalCodeMain(
          config,
          connection,
  ...
  protected void getV1PurchaseOrdersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
