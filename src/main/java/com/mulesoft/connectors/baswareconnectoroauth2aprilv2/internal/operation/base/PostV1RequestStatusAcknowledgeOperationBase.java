...
public abstract class PostV1RequestStatusAcknowledgeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/requestStatus/acknowledge";
  ...
  public PostV1RequestStatusAcknowledgeOperationBase() {
    super();
  }

  public PostV1RequestStatusAcknowledgeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1RequestStatusAcknowledge(
    ...
    try {
      ...
      postV1RequestStatusAcknowledgeMain(
          config,
          connection,
          contentTypeHeader,
  ...
  protected void postV1RequestStatusAcknowledgeMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1RequestStatusAcknowledgeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
