...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1ExchangeRatesOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1ExchangeRatesOperationRefinement;
...
public class GetV1ExchangeRatesOperation extends GetV1ExchangeRatesOperationRefinement {
  public GetV1ExchangeRatesOperation() {
    super();
  }

  public GetV1ExchangeRatesOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   *
   * <p>This operation makes an HTTP GET request to the /v1/exchangeRates endpoint
   *
  ...
  @DisplayName("Get v1 exchange rates")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1ExchangeRatesOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1ExchangeRates(
