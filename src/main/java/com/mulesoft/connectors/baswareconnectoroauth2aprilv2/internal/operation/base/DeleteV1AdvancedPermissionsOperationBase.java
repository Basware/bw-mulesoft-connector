...
public abstract class DeleteV1AdvancedPermissionsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/advancedPermissions";
  ...
  public DeleteV1AdvancedPermissionsOperationBase() {
    super();
  }

  public DeleteV1AdvancedPermissionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1AdvancedPermissions(
    ...
    try {
      ...
      deleteV1AdvancedPermissionsMain(
          config,
          connection,
  ...
  protected void deleteV1AdvancedPermissionsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1AdvancedPermissionsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
