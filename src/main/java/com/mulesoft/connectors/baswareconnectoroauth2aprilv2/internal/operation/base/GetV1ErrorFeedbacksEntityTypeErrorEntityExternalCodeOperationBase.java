...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeOperationEntityTypeUriParamEnum;
...
public abstract class GetV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeOperationBase
  ...
  public GetV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeOperationBase() {
    super();
  }
  ...
  protected void getV1ErrorFeedbacksEntityTypeErrorEntityExternalCode(
    ...
    try {
      ...
      getV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeMain(
          config,
          connection,
          entityTypeUriParam,
  ...
  protected void getV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1ErrorFeedbacksEntityTypeErrorEntityExternalCodeOperationEntityTypeUriParamEnum
          entityTypeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addUriParam("entityType", entityTypeUriParam.getValue())
            .addUriParam("errorEntityExternalCode", errorEntityExternalCodeUriParam);
    doRequest(
        config,
        connection,
        builder,
