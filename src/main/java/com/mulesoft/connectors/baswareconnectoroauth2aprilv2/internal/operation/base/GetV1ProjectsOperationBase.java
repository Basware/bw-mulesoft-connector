...
public abstract class GetV1ProjectsOperationBase extends BaseRestOperation {
  ...
  public GetV1ProjectsOperationBase() {
    super();
  }

  public GetV1ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1Projects(
  ...
  protected void getV1ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
