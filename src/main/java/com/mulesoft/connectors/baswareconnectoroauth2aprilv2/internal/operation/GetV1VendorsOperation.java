...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1VendorsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1VendorsOperationRefinement;
...
public class GetV1VendorsOperation extends GetV1VendorsOperationRefinement {
  public GetV1VendorsOperation() {
    super();
  }

  public GetV1VendorsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 vendors
   *
   * <p>This operation makes an HTTP GET request to the /v1/vendors endpoint
   *
  ...
  @DisplayName("Get v1 vendors")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1VendorsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1Vendors(
