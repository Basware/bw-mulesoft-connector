...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1ContractsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1ContractsOperationRefinement;
...
public class GetV1ContractsOperation extends GetV1ContractsOperationRefinement {
  public GetV1ContractsOperation() {
    super();
  }

  public GetV1ContractsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 contracts
   *
   * <p>This operation makes an HTTP GET request to the /v1/contracts endpoint
   *
  ...
  @DisplayName("Get v1 contracts")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1ContractsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1Contracts(
