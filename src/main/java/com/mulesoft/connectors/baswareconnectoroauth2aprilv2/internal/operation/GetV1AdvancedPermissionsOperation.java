...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1AdvancedPermissionsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1AdvancedPermissionsOperationRefinement;
...
public class GetV1AdvancedPermissionsOperation extends GetV1AdvancedPermissionsOperationRefinement {
  public GetV1AdvancedPermissionsOperation() {
    super();
  }

  public GetV1AdvancedPermissionsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Get v1 advanced permissions
   *
   * <p>This operation makes an HTTP GET request to the /v1/advancedPermissions endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param pageSizeQueryParam A limit for the number of items to be returned for one request. Li
   *     items.
  ...
  @DisplayName("Get v1 advanced permissions")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1AdvancedPermissionsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1AdvancedPermissions(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @Optional(defaultValue = "500")
          @DisplayName("Page Size")
          @Summary(
              "A limit for the number of items to be returned for one request. Li\r\n"
                  + "            items.")
    ...
    super.getV1AdvancedPermissions(
        config,
        connection,
        pageSizeQueryParam,
