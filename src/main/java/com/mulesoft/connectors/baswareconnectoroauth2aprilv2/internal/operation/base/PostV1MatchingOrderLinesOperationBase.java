...
public abstract class PostV1MatchingOrderLinesOperationBase extends BaseRestOperation {
  ...
  public PostV1MatchingOrderLinesOperationBase() {
    super();
  }

  public PostV1MatchingOrderLinesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1MatchingOrderLines(
  ...
  protected void postV1MatchingOrderLinesMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1MatchingOrderLinesBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
