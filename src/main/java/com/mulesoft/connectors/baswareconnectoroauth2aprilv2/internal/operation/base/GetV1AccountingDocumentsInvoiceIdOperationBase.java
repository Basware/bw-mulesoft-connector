...
public abstract class GetV1AccountingDocumentsInvoiceIdOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/accountingDocuments/{invoiceId}";
  ...
  public GetV1AccountingDocumentsInvoiceIdOperationBase() {
    super();
  }

  public GetV1AccountingDocumentsInvoiceIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AccountingDocumentsInvoiceId(
    ...
    try {
      ...
      getV1AccountingDocumentsInvoiceIdMain(
          config,
          connection,
          invoiceIdUriParam,
  ...
  protected void getV1AccountingDocumentsInvoiceIdMain(
      RestConfiguration config,
      RestConnection connection,
      String invoiceIdUriParam,
