...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1ExportedContractSpendsOperationDocumentTypeQueryParamEnum;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1ExportedContractSpendsOperationProcessingStatusQueryParamEnum;
...
public abstract class GetV1ExportedContractSpendsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContractSpends";
  ...
  public GetV1ExportedContractSpendsOperationBase() {
    super();
  }

  public GetV1ExportedContractSpendsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedContractSpends(
      RestConfiguration config,
      RestConnection connection,
      GetV1ExportedContractSpendsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
    ...
    try {
      ...
      getV1ExportedContractSpendsMain(
          config,
          connection,
  ...
  protected void getV1ExportedContractSpendsMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1ExportedContractSpendsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
      GetV1ExportedContractSpendsOperationDocumentTypeQueryParamEnum documentTypeQueryParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addQueryParam(
                "processingStatus",
                processingStatusQueryParam != null ? processingStatusQueryParam.getValue() : null)
            .addQueryParam(
                "documentType",
                documentTypeQueryParam != null ? documentTypeQueryParam.getValue() : null)
            .addQueryParam("pageSize", pageSizeQueryParam != null ? pageSizeQueryParam : null)
            .addQueryParam("contractExternalCode", contractExternalCodeQueryParam)
            .addQueryParam(
