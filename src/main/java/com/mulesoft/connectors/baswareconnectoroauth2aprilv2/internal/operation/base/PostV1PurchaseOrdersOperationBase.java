...
public abstract class PostV1PurchaseOrdersOperationBase extends BaseRestOperation {
  ...
  public PostV1PurchaseOrdersOperationBase() {
    super();
  }

  public PostV1PurchaseOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1PurchaseOrders(
  ...
  protected void postV1PurchaseOrdersMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1PurchaseOrdersBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
