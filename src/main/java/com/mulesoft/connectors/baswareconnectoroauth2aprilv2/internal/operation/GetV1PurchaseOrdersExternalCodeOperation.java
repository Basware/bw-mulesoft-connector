...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1PurchaseOrdersExternalCodeOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1PurchaseOrdersExternalCodeOperationRefinement;
...
public class GetV1PurchaseOrdersExternalCodeOperation
  ...
  @DisplayName("Get v1 purchase orders by external code")
  @Summary(
      "Note: This GET operation returns a HTTP redirect, which the API client needs to follow. \r\n"
