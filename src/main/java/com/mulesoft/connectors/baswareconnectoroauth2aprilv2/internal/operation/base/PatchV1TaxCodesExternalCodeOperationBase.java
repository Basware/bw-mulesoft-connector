...
public abstract class PatchV1TaxCodesExternalCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/taxCodes/{externalCode}";
  ...
  public PatchV1TaxCodesExternalCodeOperationBase() {
    super();
  }

  public PatchV1TaxCodesExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1TaxCodesExternalCode(
    ...
    try {
      ...
      patchV1TaxCodesExternalCodeMain(
          config,
          connection,
  ...
  protected void patchV1TaxCodesExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1TaxCodesExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
