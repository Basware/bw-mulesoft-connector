...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1AccountingDocumentsOperationProcessingStatusQueryParamEnum;
...
public abstract class GetV1AccountingDocumentsOperationBase extends BaseRestOperation {
  ...
  public GetV1AccountingDocumentsOperationBase() {
    super();
  }

  public GetV1AccountingDocumentsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1AccountingDocuments(
      RestConfiguration config,
      RestConnection connection,
      GetV1AccountingDocumentsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
  ...
  protected void getV1AccountingDocumentsMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1AccountingDocumentsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
      Integer pageSizeQueryParam,
