...
public abstract class GetV1PaymentTermsOperationBase extends BaseRestOperation {
  ...
  public GetV1PaymentTermsOperationBase() {
    super();
  }

  public GetV1PaymentTermsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PaymentTerms(
  ...
  protected void getV1PaymentTermsMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
