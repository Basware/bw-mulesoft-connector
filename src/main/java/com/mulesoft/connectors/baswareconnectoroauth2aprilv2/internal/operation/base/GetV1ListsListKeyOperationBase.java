...
public abstract class GetV1ListsListKeyOperationBase extends BaseRestOperation {
  ...
  public GetV1ListsListKeyOperationBase() {
    super();
  }

  public GetV1ListsListKeyOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ListsListKey(
  ...
  protected void getV1ListsListKeyMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1ListsListKeyOperationListKeyUriParamEnum listKeyUriParam,
      Integer pageSizeQueryParam,
