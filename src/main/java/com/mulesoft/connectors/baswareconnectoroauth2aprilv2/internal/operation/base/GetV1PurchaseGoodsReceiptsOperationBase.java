...
public abstract class GetV1PurchaseGoodsReceiptsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/purchaseGoodsReceipts";
  ...
  public GetV1PurchaseGoodsReceiptsOperationBase() {
    super();
  }

  public GetV1PurchaseGoodsReceiptsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseGoodsReceipts(
      RestConfiguration config,
      RestConnection connection,
      GetV1PurchaseGoodsReceiptsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
    ...
    try {
      ...
      getV1PurchaseGoodsReceiptsMain(
          config,
          connection,
  ...
  protected void getV1PurchaseGoodsReceiptsMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1PurchaseGoodsReceiptsOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
      Integer pageSizeQueryParam,
