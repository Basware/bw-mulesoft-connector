...
public abstract class PostV1PurchaseGoodsReceiptsOperationBase extends BaseRestOperation {
  ...
  public PostV1PurchaseGoodsReceiptsOperationBase() {
    super();
  }

  public PostV1PurchaseGoodsReceiptsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1PurchaseGoodsReceipts(
    ...
    try {
      ...
      postV1PurchaseGoodsReceiptsMain(
          config,
          connection,
          contentTypeHeader,
  ...
  protected void postV1PurchaseGoodsReceiptsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1PurchaseGoodsReceiptsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
