...
public class GetV1ApplicationGroupsOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/get-v1-application-groups-output-schema.json";
  }
