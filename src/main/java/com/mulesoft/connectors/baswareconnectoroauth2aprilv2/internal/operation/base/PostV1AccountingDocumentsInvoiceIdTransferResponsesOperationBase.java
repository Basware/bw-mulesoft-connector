...
public abstract class PostV1AccountingDocumentsInvoiceIdTransferResponsesOperationBase
  ...
  public PostV1AccountingDocumentsInvoiceIdTransferResponsesOperationBase() {
    super();
  }

  public PostV1AccountingDocumentsInvoiceIdTransferResponsesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1AccountingDocumentsInvoiceIdTransferResponses(
    ...
    try {
      ...
      postV1AccountingDocumentsInvoiceIdTransferResponsesMain(
          config,
          connection,
          invoiceIdUriParam,
          contentTypeHeader,
  ...
  protected void postV1AccountingDocumentsInvoiceIdTransferResponsesMain(
      RestConfiguration config,
      RestConnection connection,
      String invoiceIdUriParam,
      String contentTypeHeader,
