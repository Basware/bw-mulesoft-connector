...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1AccountingDocumentsInvoiceIdOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1AccountingDocumentsInvoiceIdOperationRefinement;
...
public class GetV1AccountingDocumentsInvoiceIdOperation
  ...
  @DisplayName("Get v1 accounting documents by invoice id")
  @Summary(
      "Note: This GET operation returns a HTTP redirect, which the API client needs to follow. \r\n"
