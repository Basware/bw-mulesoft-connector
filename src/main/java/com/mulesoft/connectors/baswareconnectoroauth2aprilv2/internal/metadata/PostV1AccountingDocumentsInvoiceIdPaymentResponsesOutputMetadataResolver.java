...
public class PostV1AccountingDocumentsInvoiceIdPaymentResponsesOutputMetadataResolver
    extends JsonOutputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-accounting-documents-invoice-id-payment-responses-input-schema.json";
  }
