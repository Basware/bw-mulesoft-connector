...
public class PostV1ExportedContractsAcknowledgeInputMetadataResolver
    extends JsonInputMetadataResolver {
  @Override
  public String getSchemaPath() {
    return "/rest_sdk_generated_schemas/post-v1-exported-contracts-acknowledge-input-schema.json";
  }
