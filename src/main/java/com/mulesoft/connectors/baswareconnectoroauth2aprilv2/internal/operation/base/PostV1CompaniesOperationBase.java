...
public abstract class PostV1CompaniesOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/companies";
  ...
  public PostV1CompaniesOperationBase() {
    super();
  }

  public PostV1CompaniesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Companies(
  ...
  protected void postV1CompaniesMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1CompaniesBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
