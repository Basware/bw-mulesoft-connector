...
public abstract class DeleteV1AdvancedValidationsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/advancedValidations";
  ...
  public DeleteV1AdvancedValidationsOperationBase() {
    super();
  }

  public DeleteV1AdvancedValidationsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteV1AdvancedValidations(
    ...
    try {
      ...
      deleteV1AdvancedValidationsMain(
          config,
          connection,
  ...
  protected void deleteV1AdvancedValidationsMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(deleteV1AdvancedValidationsBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
