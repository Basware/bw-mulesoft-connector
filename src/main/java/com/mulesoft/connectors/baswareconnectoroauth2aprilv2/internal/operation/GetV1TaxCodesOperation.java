...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1TaxCodesOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1TaxCodesOperationRefinement;
...
public class GetV1TaxCodesOperation extends GetV1TaxCodesOperationRefinement {
  public GetV1TaxCodesOperation() {
    super();
  }

  public GetV1TaxCodesOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 tax codes
   *
   * <p>This operation makes an HTTP GET request to the /v1/taxCodes endpoint
   *
  ...
  @DisplayName("Get v1 tax codes")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1TaxCodesOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1TaxCodes(
