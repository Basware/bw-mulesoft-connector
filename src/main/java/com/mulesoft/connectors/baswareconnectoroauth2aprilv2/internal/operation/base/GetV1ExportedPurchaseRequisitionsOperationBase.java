...
public abstract class GetV1ExportedPurchaseRequisitionsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedPurchaseRequisitions";
  ...
  public GetV1ExportedPurchaseRequisitionsOperationBase() {
    super();
  }

  public GetV1ExportedPurchaseRequisitionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ExportedPurchaseRequisitions(
    ...
    try {
      ...
      getV1ExportedPurchaseRequisitionsMain(
          config,
          connection,
          statusQueryParam,
          pageSizeQueryParam,
  ...
  protected void getV1ExportedPurchaseRequisitionsMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1ExportedPurchaseRequisitionsOperationStatusQueryParamEnum statusQueryParam,
      Integer pageSizeQueryParam,
