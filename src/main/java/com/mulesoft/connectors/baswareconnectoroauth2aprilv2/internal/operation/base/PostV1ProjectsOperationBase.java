...
public abstract class PostV1ProjectsOperationBase extends BaseRestOperation {
  ...
  public PostV1ProjectsOperationBase() {
    super();
  }

  public PostV1ProjectsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1Projects(
  ...
  protected void postV1ProjectsMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1ProjectsBodies, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
