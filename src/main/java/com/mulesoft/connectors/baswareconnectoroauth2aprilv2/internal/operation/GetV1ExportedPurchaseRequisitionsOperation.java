...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1ExportedPurchaseRequisitionsOperationStatusQueryParamEnum;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1ExportedPurchaseRequisitionsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1ExportedPurchaseRequisitionsOperationRefinement;
...
public class GetV1ExportedPurchaseRequisitionsOperation
    extends GetV1ExportedPurchaseRequisitionsOperationRefinement {
  public GetV1ExportedPurchaseRequisitionsOperation() {
    super();
  }

  public GetV1ExportedPurchaseRequisitionsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Notes: 1) A purchase requisition is exported from P2P when the requisition is approved,
   * rejected or canceled. Requisitions are not exported while they are in approval process. 2) This
   * API supports sending webhook based [push
   * notifications](https://developer.basware.com/api/p2p/manual#PushNotifications) when new data is
   * available to be exported. 3) This GET operation returns a HTTP redirect, which the API client
   ...
   * API.
   *
   * <p>This operation makes an HTTP GET request to the /v1/exportedPurchaseRequisitions endpoint
   *
   * @param config the configuration to use
   * @param connection the connection to use
   * @param statusQueryParam Document status filter. Returns items by order document status.
  ...
  @DisplayName("Get v1 exported purchase requisitions")
  @Summary(
      "Notes:\r\n"
  ...
  @OutputResolver(
      output = GetV1ExportedPurchaseRequisitionsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1ExportedPurchaseRequisitions(
      @Config RestConfiguration config,
      @Connection RestConnection connection,
      @Optional
          @DisplayName("status")
          @Summary("Document status filter. Returns items by order document status.")
          GetV1ExportedPurchaseRequisitionsOperationStatusQueryParamEnum statusQueryParam,
    ...
    super.getV1ExportedPurchaseRequisitions(
        config,
        connection,
        statusQueryParam,
        pageSizeQueryParam,
