...
public abstract class PatchV1UsersExternalCodeOperationBase extends BaseRestOperation {
  ...
  public PatchV1UsersExternalCodeOperationBase() {
    super();
  }

  public PatchV1UsersExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void patchV1UsersExternalCode(
  ...
  protected void patchV1UsersExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(patchV1UsersExternalCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
