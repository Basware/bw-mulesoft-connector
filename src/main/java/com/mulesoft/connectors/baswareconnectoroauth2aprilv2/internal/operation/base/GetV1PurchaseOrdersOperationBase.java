...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1PurchaseOrdersOperationProcessingStatusQueryParamEnum;
...
public abstract class GetV1PurchaseOrdersOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/purchaseOrders";
  ...
  public GetV1PurchaseOrdersOperationBase() {
    super();
  }

  public GetV1PurchaseOrdersOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1PurchaseOrders(
  ...
  protected void getV1PurchaseOrdersMain(
      RestConfiguration config,
      RestConnection connection,
      GetV1PurchaseOrdersOperationProcessingStatusQueryParamEnum processingStatusQueryParam,
      Integer pageSizeQueryParam,
