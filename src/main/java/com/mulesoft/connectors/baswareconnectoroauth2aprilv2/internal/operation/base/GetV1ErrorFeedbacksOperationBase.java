...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.api.metadata.GetV1ErrorFeedbacksOperationEntityTypeQueryParamEnum;
...
public abstract class GetV1ErrorFeedbacksOperationBase extends BaseRestOperation {
  ...
  public GetV1ErrorFeedbacksOperationBase() {
    super();
  }

  public GetV1ErrorFeedbacksOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ErrorFeedbacks(
  ...
  protected void getV1ErrorFeedbacksMain(
      RestConfiguration config,
      RestConnection connection,
      String targetSystemQueryParam,
      GetV1ErrorFeedbacksOperationEntityTypeQueryParamEnum entityTypeQueryParam,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .addQueryParam("targetSystem", targetSystemQueryParam)
            .addQueryParam(
