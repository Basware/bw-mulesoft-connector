...
public abstract class GetV2ProjectsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV2ProjectsExternalCodeOperationBase() {
    super();
  }

  public GetV2ProjectsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV2ProjectsExternalCode(
  ...
  protected void getV2ProjectsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
