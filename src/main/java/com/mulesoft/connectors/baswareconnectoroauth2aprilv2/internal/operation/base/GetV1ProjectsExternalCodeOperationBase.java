...
public abstract class GetV1ProjectsExternalCodeOperationBase extends BaseRestOperation {
  ...
  public GetV1ProjectsExternalCodeOperationBase() {
    super();
  }

  public GetV1ProjectsExternalCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1ProjectsExternalCode(
  ...
  protected void getV1ProjectsExternalCodeMain(
      RestConfiguration config,
      RestConnection connection,
      String externalCodeUriParam,
