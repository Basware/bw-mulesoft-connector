...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1UsersOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1UsersOperationRefinement;
...
public class GetV1UsersOperation extends GetV1UsersOperationRefinement {
  public GetV1UsersOperation() {
    super();
  }

  public GetV1UsersOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 users
   *
   * <p>This operation makes an HTTP GET request to the /v1/users endpoint
   *
  ...
  @OutputResolver(
      output = GetV1UsersOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1Users(
