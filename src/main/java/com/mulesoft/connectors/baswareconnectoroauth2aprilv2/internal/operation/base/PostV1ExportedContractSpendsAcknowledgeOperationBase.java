...
public abstract class PostV1ExportedContractSpendsAcknowledgeOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/v1/exportedContractSpends/acknowledge";
  ...
  public PostV1ExportedContractSpendsAcknowledgeOperationBase() {
    super();
  }

  public PostV1ExportedContractSpendsAcknowledgeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postV1ExportedContractSpendsAcknowledge(
    ...
    try {
      ...
      postV1ExportedContractSpendsAcknowledgeMain(
          config,
          connection,
          contentTypeHeader,
  ...
  protected void postV1ExportedContractSpendsAcknowledgeMain(
      RestConfiguration config,
      RestConnection connection,
      String contentTypeHeader,
    ...
    RestRequestBuilder builder =
        new RestRequestBuilder(
            ...
            .setBody(postV1ExportedContractSpendsAcknowledgeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
