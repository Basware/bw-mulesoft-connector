...
public abstract class GetV1CompaniesOperationBase extends BaseRestOperation {
  ...
  public GetV1CompaniesOperationBase() {
    super();
  }

  public GetV1CompaniesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1Companies(
  ...
  protected void getV1CompaniesMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String lastUpdatedQueryParam,
