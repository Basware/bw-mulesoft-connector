...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1CostCentersOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1CostCentersOperationRefinement;
...
public class GetV1CostCentersOperation extends GetV1CostCentersOperationRefinement {
  public GetV1CostCentersOperation() {
    super();
  }

  public GetV1CostCentersOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   * Get v1 cost centers
   *
   * <p>This operation makes an HTTP GET request to the /v1/costCenters endpoint
   *
  ...
  @DisplayName("Get v1 cost centers")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1CostCentersOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1CostCenters(
