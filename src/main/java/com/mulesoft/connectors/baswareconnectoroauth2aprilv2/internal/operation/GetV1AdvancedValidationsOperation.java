...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1AdvancedValidationsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1AdvancedValidationsOperationRefinement;
...
public class GetV1AdvancedValidationsOperation extends GetV1AdvancedValidationsOperationRefinement {
  public GetV1AdvancedValidationsOperation() {
    super();
  }

  public GetV1AdvancedValidationsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  /**
   * Get v1 advanced validations
   *
   * <p>This operation makes an HTTP GET request to the /v1/advancedValidations endpoint
   *
  ...
  @DisplayName("Get v1 advanced validations")
  @MediaType("application/json")
  @OutputResolver(
      output = GetV1AdvancedValidationsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1AdvancedValidations(
    ...
    super.getV1AdvancedValidations(
        config,
        connection,
        pageSizeQueryParam,
