...
public abstract class GetV1TaxCodesOperationBase extends BaseRestOperation {
  ...
  public GetV1TaxCodesOperationBase() {
    super();
  }

  public GetV1TaxCodesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getV1TaxCodes(
  ...
  protected void getV1TaxCodesMain(
      RestConfiguration config,
      RestConnection connection,
      Integer pageSizeQueryParam,
      String companyCodeQueryParam,
