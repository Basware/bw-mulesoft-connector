...
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.GetV1PaymentTermsOutputMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.baswareconnectoroauth2aprilv2.internal.operation.refinement.GetV1PaymentTermsOperationRefinement;
...
public class GetV1PaymentTermsOperation extends GetV1PaymentTermsOperationRefinement {
  public GetV1PaymentTermsOperation() {
    super();
  }

  public GetV1PaymentTermsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }
   ...
   *
   * <p>This operation makes an HTTP GET request to the /v1/paymentTerms endpoint
   *
  ...
  @OutputResolver(
      output = GetV1PaymentTermsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getV1PaymentTerms(
